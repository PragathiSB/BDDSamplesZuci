...
public class LoginPageSteps {
	...
	public void user_enter_credentials() {
		driver.findElement(By.xpath("//input[@placeholder='Email']")).sendKeys("pragathisayee@gmail.com");
		driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys("pragathi");
		driver.findElement(By.xpath("//button[contains(text(),'Sign in')]")).click();
	    
	}
	@Then("should display success message")
	public void should_display_success_message() {
	    boolean check=driver.findElement(By.xpath("//a[@href='#@pragathi']")).isDisplayed();
